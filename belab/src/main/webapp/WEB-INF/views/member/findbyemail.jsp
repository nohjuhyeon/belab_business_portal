...
<head>
  ...
  <style>
    ...
    .find-email-container .form-group {
      margin-bottom: 20px;
    }

    .find-email-container label {
      font-weight: bold;
      margin-bottom: 5px;
      display: block;
      color: #555;
    ...
    .find-email-container input[type="text"] {
      width: 100%;
      padding: 12px;
    ...
    .find-email-container button:hover {
      background-color: #6a1b1b;
      color: #fff;
    }

    .find-email-container .links {
      margin-top: 20px;
      display: flex;
      justify-content: flex-end;
    }

    .find-email-container .links a {
      font-size: 14px;
      color: #6a1b1b;
    ...
    .find-email-container .links a:hover {
      color: #333;
    ...
    <div class="find-email-container">
      ...
      <form action="/member/findEmail" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" id="hp" name="hp" placeholder="휴대폰 번호를 입력하세요" required>
        </div>
