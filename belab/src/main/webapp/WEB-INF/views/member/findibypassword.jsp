        ...
        <div class="contents-container container-full">
          <div class="contents-inner">
            ...
            <div class="contents-body">
              <div class="textset">
                <h2 class="h1 textset-tit">비밀번호 찾기</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="contents-inner">
            <form action="/member/findPassword" method="post">
              <div class="form-group">
                <div class="textset">
                  <h2 class="h2 textset-tit">비밀번호 찾기</h2>
                </div>
                <div class="form-box">
                  <div class="inputset">
                    <label for="email" class="form-tit h6" >이메일</label>
                    <input class="inputset-input form-control" type="email" id="email" name="email" placeholder="등록된 이메일을 입력하세요" required="">
                  </div>
                </div>
                <div class="form-box">
                  <div class="inputset">
                ...
                <div class="form-btn">
                  <button class="btnset btnset-primary" type="submit">비밀번호 찾기</button>
                </div>
