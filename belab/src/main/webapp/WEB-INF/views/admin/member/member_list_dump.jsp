                        ...
                        <div class="contents-inner">
                            <div class="form-group">
                                <form id="modifyForm" action="/admin/modify" method="post"
                                            ...
                                            <div class="checkset checkset-fill">
                                                <c:choose>
                                                    <c:when test="${not empty member && member.role == 'belab'}">
                                                        <input id="belab" name="role" class="checkset-input"
                                                               type="radio" value="belab"
                                                               checked/>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <input id="belab" name="role" class="checkset-input"
                                            ...
                                            <div class="checkset checkset-fill">
                                                <c:choose>
                                                    <c:when test="${not empty member && member.role == 'user'}">
                                                        <input id="user" name="role" class="checkset-input" type="radio"
                                                               value="user"
                                                               checked/>
                                                    </c:when>
                                                    <c:otherwise>
                                            ...
                                            <div class="checkset checkset-fill">
                                                <c:choose>
                                                    <c:when test="${not empty member && member.role == 'admin'}">
                                                        <input id="admin" name="role" class="checkset-input"
                                    ...
                                    <div class="form-btn">
                                        <button id="submitButton" class="btnset btnset-primary" type="submit">수정하기
                                        </button>
