                                        ...
                                        <div class="form-box">
                                            <div class="inputset">
                                                ...
                                                <input id="title" type="text" name="title"
                                                    class="inputset-input form-control" placeholder="제목을 입력하세요"
                                                    required />
                                            </div>
                                        </div>
                                        <div class="form-box">
                                            <div class="inputset">
                                                ...
                                                <textarea id="content" name="content"
                                                    class="inputset-textarea form-control" placeholder="내용을 입력해주세요."
                                                    required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-box">
                                            ...
                                            <!-- 업로드된 파일 목록 -->
                                            <div id="uploadedFiles" class="uploaded-file-item-list"
                                                style="display: none;">
                                            </div>
                                        </div>
